          ...
          if (newLives <= 0) {
            ...
            if (email) {
              fetch('https://clementeurzua.pythonanywhere.com/add_email', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ email: email, score: score, mode: 'easy' })
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-lg mb-4">
              Obstáculos predecibles • Velocidad máxima 20x
            </p>
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/50 rounded-lg p-4 max-w-2xl mx-auto">
              ...
              <ul className="text-gray-300 text-sm space-y-1">
                <li>• 3 vidas iniciales ❤️❤️❤️</li>
                <li>• Velocidad máxima: 20x</li>
                <li>• Obstáculos aparecen cada 3 segundos (predecible)</li>
            ...
            <div className="flex flex-col items-center space-y-6">
              <div className="relative">
                <canvas
                  ...
                  width={800}
                  height={200}
                  className="border-2 border-green-500/50 rounded-lg bg-gradient-to-b from-gray-800 to-gray-900 shadow-2xl"
              ...
              <div className="flex items-center space-x-4">
                {!gameStarted ? (
                  <button onClick={startGame} className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg flex items-center space-x-2 px-6 py-3 transition-all duration-300">
                    <Play className="w-5 h-5" />
                    <span>Iniciar Juego</span>
                  </button>
                ) : (
                  <>
                    <button onClick={pauseGame} className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg flex items-center space-x-2 px-6 py-3 transition-all duration-300" disabled={gameOver}>
